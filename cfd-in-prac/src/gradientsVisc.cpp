/// @file gradientsVisc.cpp
///
/// Computation of gradients (rho, u, v, p, T) at the grid nodes.
///
//*****************************************************************************
//
...
/// with respect to the x- and y-coordinates. Gradients are evaluated at the
/// grid nodes.
///
/// @param geometry    geometrical data
/// @param fluidProps  fluid properties
///
void SpaceDiscr::GradientsVisc( const Geometry &geometry, const FluidProps &fluidProps )
{
  bool flag;
  int  i, j, ib, ibf, ibn, ie, ibegf, iendf, ibegn, iendn;
  REAL rav, uav, vav, pav, tav, sx, sy;
  REAL fcx[5], fcy[5];
  ...
  BndConds::Periodic( geometry,gradTx,gradTy );
